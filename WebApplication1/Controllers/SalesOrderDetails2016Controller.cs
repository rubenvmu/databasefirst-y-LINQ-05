...
{
    public class SalesOrderDetails2016Controller : Controller
    {
        private readonly AdventureWorks2016Context _context;

        public SalesOrderDetails2016Controller(AdventureWorks2016Context context)
        {
            _context = context;
        }

        // GET: SalesOrderDetails2016
        public async Task<IActionResult> Index()
        {
            var adventureWorks2016Context = _context.SalesOrderDetail
                    .Include(s => s.SalesOrder)
                    .Where(so => so.SalesOrder.OrderDate.Year == 2016)
                ;

            return View(await adventureWorks2016Context.ToListAsync());
        }

        // GET: SalesOrderDetails2016/Details/5
        ...
        // GET: SalesOrderDetails2016/Create
        ...
        // POST: SalesOrderDetails2016/Create
        ...
        // GET: SalesOrderDetails2016/Edit/5
        ...
        // POST: SalesOrderDetails2016/Edit/5
        // To protect from overposting attacks, enable the specific properties you want to bind to.
        // For more details, see http://go.microsoft.com/fwlink/?LinkId=317598.
        [HttpPost]
        [ValidateAntiForgeryToken]
        ...
        // GET: SalesOrderDetails2016/Delete/5
        ...
        // POST: SalesOrderDetails2016/Delete/5
