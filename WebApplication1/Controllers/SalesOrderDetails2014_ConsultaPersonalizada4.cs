...
{
    public class SalesOrderDetails2014_ConsultaPersonalizada4 : Controller
    {
        private readonly AdventureWorks2016Context _context;

        public SalesOrderDetails2014_ConsultaPersonalizada4(AdventureWorks2016Context context)
        {
            _context = context;
        }
