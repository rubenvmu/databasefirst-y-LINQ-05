...
{
    public class SalesOrderDetails2013_ConsultaPersonalizada3Controller : Controller
    {
        private readonly AdventureWorks2016Context _context;

        public SalesOrderDetails2013_ConsultaPersonalizada3Controller(AdventureWorks2016Context context)
        {
            _context = context;
        }
